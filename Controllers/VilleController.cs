...
namespace Controllers
{
    ...
    [ApiController]
    public class VillesController : SuperController<Ville>
    {
        public VillesController(MyContext context ) : base(context)
        { }
...
.Where(e => nomAr == "*" ? true : e.NomAr.ToLower().Contains(nomAr.ToLower()))
            ...
            var list = await q.OrderByName<Ville>(sortBy, sortDir == "desc")
                .Skip(startIndex)
                .Take(pageSize)
